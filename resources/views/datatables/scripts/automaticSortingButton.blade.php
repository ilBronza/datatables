...
<a href="{{ route('workstations.orders.resetSorting', ['workstation' => $workstation]) }}" class="reduce-order-index uk-button uk-button-default uk-button-small">Resetta valori</a>
