...
$('body').on('click', '.ib-ajax', function (e) {
    ...
    // Date/datetime: native picker commits on change, often after blur — save on change when trigger is blur
    $('body').on('change', '.ib-editor-text[type="date"], .ib-editor-text[type="datetime-local"], .ib-editor-text[type="time"]', function (e)
    {
        ...
        window.__ibLogEditorDebug(el, { event: 'change-date', saveTriggerResolved: trigger });

        setTimeout(function ()
        {
            $(el).trigger('ib:dt-editor-save', { source: 'change-date' });
        }, 0);
    });
