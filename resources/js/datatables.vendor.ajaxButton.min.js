...
// Global save button (appears when there are unsaved editor fields)
    // Per-table save button toggle + click handler
    window.__ibGetTableDomIdByEditor = function (target)
    {
        // Prefer DataTables table id if available
    ...
    window.__ibTogglePerTableSaveButton = function (target)
    {
        ...
        const hasDirty = $table.find('.editorchanged').length > 0;
