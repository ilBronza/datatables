...
$.fn.dataTable.ext.buttons.selectedRows =
{
    ...
    action: function ( e, dt, node, config )
    {
        ...
        let showSelected = dt.getData('showSelected');
...
$.fn.dataTable.ext.buttons.doubler =
{
    ...
    action: function ( e, dt, node, config )
    {
        ...
        let showDuplicates = dt.getData('showDuplicates');
...
$.fn.dataTable.ext.buttons.removeInlineSearch = {
    ...
    action: function ( e, dt, node, config )
    {
        ...
        if(summaryActive)
            $(node).parents('.dataTables_wrapper').find('tr.inlinesearchsummary').fadeIn();

        else
            $(node).parents('.dataTables_wrapper').find('tr.inlinesearchsummary').fadeOut();
    }
}; 
