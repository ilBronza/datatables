$.fn.dataTable.Api.register( '_drawCallback()', function ()
{
    ...
    if (this.getData('showDuplicates'))
...
$.fn.dataTable.Api.register('getData()', function (dataName, table = null)
{
    if(! table)
    ...
    $('.wannabedatatable').each(function()
    {
        ...
        let settings = {
            ...
            initComplete: function ()
            {
                ...
                // {
                //     if(! $(this.header()).data('filterable'))
                //         return ;

                //     if($(this.header()).data('range'))
                //         window.rangeFilter(that, this, this.header());
                //     else
                //         window.normalFilter(that, this, this.header());
                // });
