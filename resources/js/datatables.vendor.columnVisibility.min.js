		...
		$(document).ready(function($)
		{
			...
			if (! window.__ibColumnSettingsPreviewBound)
			{
				...
				function hydrateFormInstanceFromDom($instance, dt)
				{
					...
					$(nodes).each(function () {
						...
						cssSelectors.forEach(function (cssSel) {
							...
							$targets.each(function () {
								...
								collected.textOverflowMode.push({
					...
					collected.textOverflowMode = collected.textOverflowMode.map(function (o) {
						if (! o) return o;
							...
							cssSelectors.forEach(function (cssSel) {
								...
								$targets.each(function () {
									...
									styleKeys.forEach(function (styleKey) {
										...
										// Special pseudo-style: textOverflowMode
										if (styleKey === 'textOverflowMode')
										{
											// Reset first
